...
# File paths
    ...
    models_path = "faz_e_conta_2.0/data_hub/models.py"
    admin_path = "faz_e_conta_2.0/data_hub/admin.py"
    forms_path = "faz_e_conta_2.0/data_hub/forms.py"
...
# Create HTML files for forms
        ...
        for table_name in class_list:
            form_html_path = f"faz_e_conta_2.0/data_hub/templates/insert_{table_name.lower()}.html"
...
# Add classes to form_url.py
        ...
        with open("faz_e_conta_2.0/data_hub/auto_gen_form_url.py", "w", encoding="utf-8") as arquivo:
...
# Add links to links.html
        ...
        table = ""
        with open("faz_e_conta_2.0/data_hub/templates/links.html", "w", encoding="utf-8") as arquivo:
...
# Add HTML files for views by id
        ...
        for table_name in class_list:
            view_html_path = f"faz_e_conta_2.0/data_hub/templates/show_{table_name.lower()}.html"
...
# Add urls to id_views.py
        ...
        with open("faz_e_conta_2.0/data_hub/auto_gen_show_id_url.py", "w", encoding="utf-8") as arquivo:
            arquivo.write("from django.urls import path\n")
            arquivo.write("from . import views\n\n")
